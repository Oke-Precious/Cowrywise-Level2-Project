...
function payWithPaystack() {
    ...
    const amountInNaira = parseInt(amountInput.value.replace(/[^0-9]/g, ''), 10);
    const totalAmount = amountInNaira + 15; // Including processing fee

    const handler = PaystackPop.setup({
        key: 'pk_test_765391a225072f8da2b43d0317158769f01623ad', 
